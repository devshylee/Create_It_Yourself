...
<div class="box">
    <div class="group">
        <div class="overlap-group">
            ...
            <div class="icon" onclick="toggleSidebar()"><img alt = '' class="img" src="${pageContext.request.contextPath}/resources/img/person_FILL0_wght400_GRAD0_opsz24.png" /></div>
...
<%--    <h2>${sessionScope.loginEmail} 님 환영합니다.(연동 확인 테스트용)</h2>--%>
...
<%--                    <div class="menu-item"><button onclick="update()">userUpdate</button></div>--%>
<%--                </form>--%>
<%--                <form action="${pageContext.request.contextPath}/resources/html/sign-in.html">--%>
<%--                    <div class="menu-item"><button onclick="logout()">userLogout</button></div>--%>
<%--                </form>--%>
<%--                <div class="menu-item"><button onclick="update()">내정보</button></div>--%>
<%--            </div>--%>
<%--            <div class="text-wrapper-20">CBY.com</div>--%>
<%--        </div>--%>
<%--    </div>--%>
<%--</div>--%>
<%--&lt;%&ndash;<div class="welcome-section">&ndash;%&gt;--%>
<%--&lt;%&ndash;    <h2>${sessionScope.loginEmail} 님 환영합니다.(연동 확인 테스트용)</h2>&ndash;%&gt;--%>
<%--&lt;%&ndash;    <button onclick="update()">내정보 수정하기</button>&ndash;%&gt;--%>
<%--&lt;%&ndash;    <button onclick="logout()">로그아웃</button>&ndash;%&gt;--%>
<%--&lt;%&ndash;</div>&ndash;%&gt;--%>
<%--</body>--%>
<%--</html>--%>